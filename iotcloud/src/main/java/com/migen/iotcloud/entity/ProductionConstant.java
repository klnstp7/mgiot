...
public class ProductionConstant
{
    ...
    {
	    return "StuffDetailConstantBean [sdid=" + sdid + ", did=" + did + ", sid=" + sid + ", total=" + total
	            + ", lefts=" + lefts + ", thistime=" + thistime + ", dt=" + dt + ", curColor=" + curColor
	            + ", modelCut=" + modelCut + ", curCount=" + curCount + ", boardLong=" + boardLong + ", paperSpeed="
	            + paperSpeed + ", removeInkSpeed=" + removeInkSpeed + ", returnInkSpeed=" + returnInkSpeed
	            + ", printSpeed=" + printSpeed + ", relVolumeRadius=" + relVolumeRadius + ", relVolumeMaxDis="
	            + relVolumeMaxDis + ", relVolumeCurDis=" + relVolumeCurDis + ", colVolumeRadius=" + colVolumeRadius
